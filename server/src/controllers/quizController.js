...
exports.submitQuiz = exports.manageQuiz = exports.getQuiz = void 0;
...
exports.manageQuiz = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
    const { lessonId } = req.params;
    ...
    if (!lesson)
        return next(new appError_1.AppError('Lesson not found', 404));
    if (lesson.section.course.instructorId !== req.user.id && req.user.role !== 'ADMIN') {
        return next(new appError_1.AppError('Not authorized to manage this quiz', 403));
    }
    // Upsert Quiz
...
exports.submitQuiz = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
