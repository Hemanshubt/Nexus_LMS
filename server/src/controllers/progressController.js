...
exports.updateLessonProgress = exports.getCourseProgress = void 0;
const catchAsync_1 = require("../utils/catchAsync");
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
exports.getCourseProgress = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
...
exports.updateLessonProgress = (0, catchAsync_1.catchAsync)(async (req, res, next) => {
